...
Вас попрохають ввести ваш  <code>МАСТЕР ПАРОЛЬ</code>.
Мастер пароль знадобиться, задля того щоб пізніше <b>розшифрувати</b> зашифровані паролі.

⚠️<b>ВИ ПОВИННІ ВИДАЛИТИ ПОВІДОМЛЕННЯ З ПАРОЛЕМ З ЛИСТУВАННЯ</b>

📋<i>Приклад:</i> my-master-password-123
""",
        "describe en 2": """
☑️2. Вас попрохають ввести пароль/фразу, котру ви бажаєте зашифрувати.
...
⚠️<b>ВИДАЛЯЙТЕ ВСІ ПОВІДОМЛЕННЯ З ПАРОЛЯМИ В ЛИСТУВАННІ З БОТОМ</b>

⚠️<b>БОТ НЕ ЗБЕРІГАЄ ВАШІ ПАРОЛІ, ЗБЕРІГАЄТЬСЯ ТІЛЬКІ ОБРАНА МОВА</b>

⚠️<b>МИ ЗМІНЮЄМО ТОКЕН БОТА ЩОМІСЯЦЯ, ТАКИМ ЧИНОМ ДОСТУП ДО КОЛИШНІХ ПОВІДОМЛЕНЬ БУДЕ ВТРАЧЕНО</b>
...
""",
        "describe de 3": """
☑️3. На выході ви отримуєте свій пароль всередені лапок.

⚠️<b>ВИДАЛЯЙТЕ ВСІ ПОВІДОМЛЕННЯ З ПАРОЛЯМИ В ЛИСТУВАННІ З БОТОМ</b>

⚠️<b>БОТ НЕ ЗБЕРІГАЄ ВАШІ ПАРОЛІ, ЗБЕРІГАЄТЬСЯ ТІЛЬКІ ОБРАНА МОВА</b>

⚠️<b>МИ ЗМІНЮЄМО ТОКЕН БОТА ЩОМІСЯЦЯ, ТАК ЩО ДОСТУП ДО КОЛИШНІХ ПОВІДОМЛЕНЬ БУДЕ ВТРАЧЕНО</b>

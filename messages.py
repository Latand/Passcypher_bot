...
""",
        "describe en 4": """
☑️4. Збережіть цю інформацію де вам зручно, та звертайтесь до бота, коли вам потрібно буде розшифрувати пароль. 
...
Збережіть цю інформацію де вам зручно, та звертайтесь до бота, коли вам потрібно буде розшифрувати пароль. 
""",
        "result_encode_doc":
            """
----------------------------
